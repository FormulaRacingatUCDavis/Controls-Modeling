...
Kxk = ( ContactPatchLoads( Tire, 0, 0.01, Fz0 , 80, 0, 10, 1, Fidelity ) - ...
        ContactPatchLoads( Tire, 0, 0.00, Fz0 , 80, 0, 10, 1, Fidelity ) ) ./ 0.01;
    % Slip Stiffness [N/[]]
    
Parameter.Re = Tire.Radius.Effective( 0, Fz0, 80 ) ./ 1000; % Nominal Effective Radius [m]
